#!/usr/bin/env python3
""" Our own "This person does not exist" : Playing with a pre-trained model """
...
class WGAN_GP(keras.Model):
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """
        Replaces the weights of the generator and discriminator with the
        weights from the given files.

        Arguments:
            - gen_h5 (str): Path to the generator weights file.
            - disc_h5 (str): Path to the discriminator weights file.
        """
