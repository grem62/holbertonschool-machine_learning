...
chemin_train = os.path.join(script_directory, 'data', 'MNIST.npz')
lib = np.load(chemin_train)
...
script_directory = os.path.dirname(os.path.realpath(__file__))
chemin_train2 = os.path.join(script_directory, 'data', '27-saved.pkl')
deep = Deep.load(chemin_train2)
